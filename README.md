...
**开发者工具箱** — 126 款实用工具，基于 Cloudflare Pages Functions 全栈部署

[![Version](https://img.shields.io/badge/version-2.3.0-blue.svg)](https://github.com/your-username/it-toolbox)
...
IT Toolbox 是一款面向开发者的在线工具箱，集成 126 款高频开发工具，覆盖格式化、编码解码、加密安全、网络查询、文本处理、颜色设计等多个类别。
...
| AI 增强 | 6 | AI代码解释/AI正则生成/AI SQL生成/AI代码Review/AI生成Schema/AI生成提交信息 |
| 数学计算 | 4 | 数学表达式/质数检测/GCD-LCM/浮点数可视化 |
| **总计** | **126** | |
...
### Phase 4（进行中 🚧）
- AI增强工具（已完成2个：AI生成Schema、AI生成提交信息）
- 待完成：AI结构化提取、AI翻译、AI命名助手、AI报错解释、AI生成Mock数据、AI Shell命令生成
- 计划中：效率协作功能、前端工具扩展
